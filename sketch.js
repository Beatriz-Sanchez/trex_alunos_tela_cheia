var trex, trex_correndo, bordas, solo, soloInvisivel, imagemDaNuvem, obstaculo, pontuacao, grupoDeNuvens, grupoDeObstaculos, trex_colidiu, imagemDoSolo;
var obstaculo1, obstaculo2, obstaculo3, obstaculo4, obstaculo5, obstaculo6, imagemFimDoJogo, imagemReiniciar;
var somSalto, somMorte, somCheckPoint, fimDoJogo, reiniciar;
var JOGAR = 1;
var ENCERRAR = 0;
...
function draw() {
  ...
  if (estadoJogo === JOGAR) {
    ...
    solo.velocityX = -(4 + 5 * pontuacao / 100);
...
function gerarObstaculos() {
  ...
  if (frameCount % 60 === 0) {
    ...
    obstaculo.velocityX = -(6 + 5 * pontuacao / 100);
